...
Ici On va ne garder qu'une partie des données pour l'experimenation d'albiziapp
...
```{r}
se_xp_map <- tm_shape(arbres_xp) # on fait un objet tmap
# on y ajoute ce que le l'on veut
se_xp_map + tm_dots("genus") 
```
